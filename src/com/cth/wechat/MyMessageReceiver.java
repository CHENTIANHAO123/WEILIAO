...
import com.cth.wechat.ui.MainActivity;
...
public class MyMessageReceiver extends BroadcastReceiver {
	...
	public final static int NOTIFY_ID = 0x000;
	...
	public void showOtherNotify(Context context,String username,String toId,String ticker,Class<?> cls){
		...
		if(isAllow && currentUser!=null && currentUser.getObjectId().equals(toId)){
			//同时提醒通知
			BmobNotifyManager.getInstance(context).showNotify(isAllowVoice,isAllowVibrate,R.drawable.ic_launcher, ticker,username, ticker.toString(),NewFriendsActivity.class);
		}
	}
}
